<?php get_header(); ?>
  <!-- Каталог -->
  <!-- создание кода для вывода произвольных полей на рубрике без самостоятельного шаблона -->
  <?php 
  $settings = get_posts( [
    'numberposts' => 1,
  ...
  ?>
		...
		<div class="container">
			...
			<div class="category-controll text-center">
				...
				<button class="btn" type="button" data-filter=".<?php echo get_category( 17, ARRAY_A )['slug'] ?>"><?php echo get_category( 17, ARRAY_A )['name'] ?></button>
          ...
          if(have_posts()) {
            while(have_posts()) {
              ...
              foreach($all_category as $category) {
                if($category->term_id == 15 || $category->term_id == 16 || $category->term_id == 18) {
